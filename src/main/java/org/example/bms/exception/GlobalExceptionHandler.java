...
return new ResponseEntity<>(errorDetails,HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<?> resourceNotFoundException(Exception ex, WebRequest request){
        ...
        ErrorResponse errorDetails=new ErrorResponse(new Date(), HttpStatus.INTERNAL_SERVER_ERROR.value(),"Internal Servor error",ex.getMessage(),request.getDescription(false));
